//
//  FolderViewController+Language.swift
//  InformationSystem
//
...
extension FolderViewController  {
    override func changeLanguageToSlovak(_ notification: Notification) {
        ...
        noDocumentsView.messageText = "V priečinku nie sú žiadne dokumenty"
    ...
    override func changeLanguageToEnglish(_ notification: Notification) {
        ...
        noDocumentsView.messageText = "You have no documents in this folder"
